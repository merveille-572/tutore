								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>{{number_format($cart['price'],2)}} XAF</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">{{$cart['amount']}} XAF</span></td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">You Save<span>{{number_format(Session::get('coupon')['value'],2)}} XAF</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">You Pay<span>{{number_format($total_amount,2)}} XAF</span></li>
										@else
											<li class="last" id="order_total_price">You Pay<span>{{number_format($total_amount,2)}} XAF</span></li>
										@endif
									</ul>
